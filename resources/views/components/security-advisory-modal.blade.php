...
<div 
    ...
    class="fixed inset-0 bg-slate-950/75 backdrop-blur-md z-[110] flex items-center justify-center p-4 transition-opacity duration-300 opacity-0 pointer-events-none"
    role="dialog"
    aria-modal="true"
    aria-labelledby="desktopModalTitle"
>
    <div class="bg-white rounded-3xl border border-emerald-100 shadow-2xl max-w-md w-full p-5 sm:p-7 flex flex-col gap-4 sm:gap-5 transform transition-all duration-300 scale-95 max-h-[92vh] overflow-y-auto">
        <!-- Header -->
        <div class="flex items-start justify-between border-b border-gray-100 pb-3 sm:pb-4">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-emerald-50 border border-emerald-200 text-[#006c49] flex items-center justify-center shrink-0 shadow-sm">
                ...
                <div>
                    <span class="text-[9px] sm:text-[10px] font-black uppercase tracking-wider text-emerald-800 bg-emerald-100 px-2 py-0.5 rounded-md">Tips Eksplorasi</span>
            ...
            <button 
                ...
                class="text-gray-400 hover:text-gray-700 p-1.5 rounded-xl hover:bg-gray-100 transition-colors"
        ...
        <div class="space-y-2 font-sans text-xs">
            <div class="flex items-start gap-2.5 p-2.5 sm:p-3 rounded-xl bg-slate-50 border border-slate-100">
                <span class="text-base leading-none mt-0.5 shrink-0">🖥️</span>
                <div>
                    <b class="text-gray-900 text-[11px] sm:text-xs block font-bold">Layar Luas & Galeri Tajam</b>
                    <span class="text-gray-500 text-[10px] sm:text-[11px] leading-tight block">Melihat spesifikasi kamar dan kamar mandi dalam lebih leluasa.</span>
                </div>
            </div>
            ...
            <div class="flex items-start gap-2.5 p-2.5 sm:p-3 rounded-xl bg-slate-50 border border-slate-100">
                ...
                <div>
                    <b class="text-gray-900 text-[11px] sm:text-xs block font-bold">Akses Mobile Tetap Ramah</b>
                    <span class="text-gray-500 text-[10px] sm:text-[11px] leading-tight block">Pemesanan, tanya jawab cepat, dan verifikasi sewa tetap lancar di smartphone Anda.</span>
                </div>
            </div>
        </div>
        ...
        <div class="pt-1">
            <button 
                type="button" 
                onclick="proceedFromDesktopToSecurityModal()" 
                class="w-full bg-[#006c49] hover:bg-[#005236] text-white py-3 sm:py-3.5 rounded-2xl font-bold text-xs shadow-md shadow-[#006c49]/20 transition-all cursor-pointer active:scale-95 flex items-center justify-center gap-2"
            >
...
<div 
    ...
    class="fixed inset-0 bg-slate-950/75 backdrop-blur-md z-[120] flex items-center justify-center p-4 transition-opacity duration-300 opacity-0 pointer-events-none"
    role="dialog"
    aria-modal="true"
    aria-labelledby="securityModalTitle"
>
    <div class="bg-white rounded-3xl border border-amber-100 shadow-2xl max-w-lg w-full p-5 sm:p-8 flex flex-col gap-4 sm:gap-6 transform transition-all duration-300 scale-95 max-h-[90vh] overflow-y-auto">
        <!-- Header with Shield Badge -->
        <div class="flex items-start justify-between border-b border-gray-100 pb-3 sm:pb-4">
            <div class="flex items-center gap-3 sm:gap-3.5">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-amber-50 border border-amber-200 text-amber-600 flex items-center justify-center shrink-0 shadow-sm">
                ...
                <div>
                    <span class="text-[9px] sm:text-[10px] font-black uppercase tracking-wider text-amber-700 bg-amber-100 px-2 py-0.5 rounded-md">Himbauan Resmi Pengelola</span>
        ...
        <!-- Warning Narrative -->
        <p class="text-[11px] sm:text-xs text-gray-600 leading-relaxed font-sans">
        ...
        <div class="space-y-2.5 sm:space-y-3 font-sans text-xs">
            <!-- Point 1: Official WhatsApp Contact -->
            <div class="flex items-start gap-2.5 sm:gap-3 p-2.5 sm:p-3.5 rounded-2xl bg-emerald-50/70 border border-emerald-100">
            ...
            <div class="flex items-start gap-2.5 sm:gap-3 p-2.5 sm:p-3.5 rounded-2xl bg-amber-50/70 border border-amber-200">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-2 p-2 sm:p-2.5 bg-white border border-amber-200 rounded-xl flex items-center justify-between gap-2">
                        <div>
                        ...
                        <button 
                            ...
                            class="px-2.5 py-1 bg-amber-100 hover:bg-amber-200 text-amber-900 font-bold text-[9px] sm:text-[10px] rounded-lg transition-colors cursor-pointer"
                        >
                            Salin Info
                        </button>
                    </div>
            ...
            <div class="flex items-start gap-2.5 sm:gap-3 p-2.5 sm:p-3.5 rounded-2xl bg-red-50/70 border border-red-200">
